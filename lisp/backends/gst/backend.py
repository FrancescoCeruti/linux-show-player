...
from lisp.backends.gst.gst_media_cue_factory import GstMediaCueFactory
...
class Backend(BaseBackend):
    def __init__(self):
        ...
        CueFactory.register_factory('MediaCue', GstMediaCueFactory)

        elements.load()
        settings.load()

    def media_cue_factory(self):
        return GstMediaCueFactory
