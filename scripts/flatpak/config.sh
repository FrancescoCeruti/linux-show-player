...
export FLATPAK_RUNTIME_VERSION="5.15-24.08"
...
export FLATPAK_PY_IGNORE="$FLATPAK_PY_INCLUDED packaging pyalsa pyliblo3 python-rtmidi pygobject pycairo pyqt5 pyqt5-sip pyqt5-qt pyqt5-qt5 numpy"
